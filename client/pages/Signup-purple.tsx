...
import { Activity, Loader2, Mail, Lock, Eye, EyeOff, User, Check } from "lucide-react";
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0e1a] via-[#1a1625] to-[#0f0e1a] flex relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative">
        <div className="max-w-lg">
          ...
          <h2 className="text-4xl font-black text-white mb-6 leading-tight">
            Transform Your Stripe Data Into Insights
          </h2>
          <p className="text-xl text-slate-300 mb-12 leading-relaxed">
            Join thousands of founders who monitor their revenue health in real-time.
          </p>

          <div className="space-y-6">
            {[
              { icon: Check, text: "Real-time MRR & ARR tracking" },
              { icon: Check, text: "Subscription analytics & churn insights" },
              { icon: Check, text: "Failed payment monitoring & recovery" },
              { icon: Check, text: "Beautiful charts & customizable dashboards" },
              { icon: Check, text: "Export reports & share with your team" },
            ].map((feature, i) => (
              <div key={i} className="flex items-start gap-4">
                <div className="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <feature.icon className="w-5 h-5 text-purple-400" />
                </div>
                <p className="text-lg text-slate-200 font-medium">{feature.text}</p>
              </div>
            ))}
          </div>

          <div className="mt-12 p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/20">
            <p className="text-slate-300 italic mb-3">
              "StripeViz transformed how we monitor revenue. We catch issues before they become problems."
            </p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-violet-600" />
              <div>
                <p className="text-white font-semibold">Sarah Chen</p>
                <p className="text-sm text-slate-400">Founder, TechFlow</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="w-full max-w-md bg-gradient-to-br from-[#1a1625] to-[#25233a] border border-white/10 rounded-2xl shadow-2xl backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="relative p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400">Start tracking your revenue today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[#1a1625] text-slate-500">Or sign up with</span>
                </div>
              </div>
